...
mod tests {
    ...
    fn collection_keeps_nonstandard_names_and_skips_duplicate_and_reserved_labels() {
        ...
        register_test_family(MetricFamily {
            name: Some("collect_row_validation_gauge_histogram".to_owned()),
            help: None,
        ...
        register_test_family(MetricFamily {
            name: Some("collect_row_validation_summary".to_owned()),
            help: None,
        ...
        for (name, expected_rows) in [
            ...
            ("collect_row_validation_gauge_histogram", 1),
            ("collect_row_validation_summary", 1),
        ] {
            let family = families
                .iter()
                .find(|family| family.name.as_deref() == Some(name))
